        ...
        <Row>
            ...
            <Col span="20">
                <Card>
                    ...
                    <Row style="margin: 10px">
                        <Col span="8">
                            <Button type="primary" v-has="'tempmeter_add'" @click="addMeter" icon="plus">新增</Button>
                            <Button type="primary" v-has="'tempmeter_edit'" @click="editMeter" icon="edit" v-bind:disabled="selectData.length!==1">编辑</Button>
                            <Button type="error" v-has="'tempmeter_del'" @click="deleteMeter" v-bind:disabled="selectData.length==0" icon="trash-a">删除</Button>
                        </Col>
        ...
        <Modal title="导入热量表" :closable=false :mask-closable=false v-model="showImportData">
            ...
            <Row>
                ...
                <Upload ref="uploadFile"
                        action="//192.168.5.21:8082/importMeters?meterType=3"
                        name="multipartFile"
                        accept="'.xlsx'"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //下载模板
            uploadTemplate(){
                uploadImportTemplates("测温设备导入模板.xlsx");
            },
            exportData(){//导出数据
